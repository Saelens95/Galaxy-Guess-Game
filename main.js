$(document).ready(function () {
    ...
    // Manually trigger re-animation every 6 seconds (adjust as needed)
    setInterval(function () {
      $('.tlt-title').textillate('out');
      setTimeout(function () {
        $('.tlt-title').textillate('in');
      }, 1500); // Delay between out and in (match your out animation duration)
    }, 6000); // Total cycle interval
...
const images = [
    ...
    'https://images-assets.nasa.gov/image/PIA00271/PIA00271~orig.jpg', // Venus 13
  ];
